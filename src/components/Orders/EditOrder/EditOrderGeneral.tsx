...
const OrderGeneral: React.FC<OrderGeneralProps> = ({ formOrder, setFormOrder }) => {
      ...
      <div className="form-grid" style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>
        <div className="form-group" style={{ flex: '1 1 45%' }}>
          ...
          <select
            ...
            onBlur={() => validateAndSetOrder('customer', formOrder.customer || '')}
            required
          >
        ...
        {fields.map(({ key, label, placeholder }) => (
          <div className="form-group" key={key} style={{ flex: '1 1 45%' }}>
            ...
            <input
              ...
              value={String(formOrder[key as keyof Order] || '')}
