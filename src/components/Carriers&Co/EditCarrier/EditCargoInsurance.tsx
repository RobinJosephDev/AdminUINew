...
const carrierSchema = z
  .object({
    ...
    ci_policy_no: z
      ...
      .regex(
        /^[a-zA-Z0-9\s.-]*$/,
        "Only letters, numbers, spaces, periods, and hyphens allowed"
      )
      .optional(),
  ...
  .refine(
    (data) =>
      !data.ci_start_date ||
      !data.ci_end_date ||
      new Date(data.ci_start_date) <= new Date(data.ci_end_date),
    {
...
const EditCargoInsurance: React.FC<EditCargoInsuranceProps> = ({
  formCarrier,
  setFormCarrier,
}) => {
